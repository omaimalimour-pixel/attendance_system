...
<a href="ai_predictions.php" class="side-link <?=$currentPage=='ai_predictions'?'active':''?>"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9.5 4A2.5 2.5 0 0 1 12 1.5 2.5 2.5 0 0 1 14.5 4 2.5 2.5 0 0 1 17 6.5 2.5 2.5 0 0 1 19.5 9a2.5 2.5 0 0 1-1 2 2.5 2.5 0 0 1-1 4.8A2.5 2.5 0 0 1 15 18.3 3 3 0 0 1-6 0 2.5 2.5 0 0 1-2.5-2.5 2.5 2.5 0 0 1-1-4.8 2.5 2.5 0 0 1-1-2A2.5 2.5 0 0 1 7 6.5 2.5 2.5 0 0 1 9.5 4Z"/><path d="M9 9h.01M15 9h.01M9 14h6"/></svg><span>AI Absence Risk</span></a>
...
<a href="device_users.php" class="side-link <?=$currentPage=='device_users'?'active':''?>"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></svg><span>Device Users</span></a>
<a href="clean_device.php" class="side-link <?=$currentPage=='clean_device'?'active':''?>" style="padding-left:28px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M8 6V4h8v2M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/></svg><span>Clean &amp; Fix Device</span></a>
<?php endif; ?>
